...
The Enterprise Contract Policy defines the configuration for the enforcement of
the Enterprise Contract by specifying rules and authorizations needed for a
container image built in Red Hat Trusted Application Pipeline to be compliant
with organization's software release policy requirements.

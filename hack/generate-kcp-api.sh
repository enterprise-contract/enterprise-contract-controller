...
KCP_API_EXPORT_FILE=$(realpath "$ROOT"/config/kcp/apiexport_enterprisecontract.yaml)
...
KCP_API_SCHEMA_FILE=$(realpath "$ROOT"/config/kcp/apiresourceschema_enterprisecontract.yaml)
